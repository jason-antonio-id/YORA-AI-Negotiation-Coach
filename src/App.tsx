...
export default function App() {
  ...
  const handleAddSupplier = async (newSupplier: Supplier) => {
    ...
    const supplierData = {
      ...
      current_price: newSupplier.currentPrice || null,
      scores: newSupplier.scores || null,
      latest_analysis: newSupplier.latestAnalysis || null,
  ...
  const handleUpdateSupplier = async (updated: Supplier) => {
    ...
    try {
      const supplierData = {
        ...
        scores: updated.scores || null,
        latest_analysis: updated.latestAnalysis || null,
